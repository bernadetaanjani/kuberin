        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="box box-info">
                    ...
                    <!-- form start -->
                    <?php echo form_open('summarize/summarizeberita', array('id'=>'formsummarize')); ?>
                    <div class="box-body">
                    ...
                    <div class="box-footer clearfix">
                        <button class="btn btn-primary btn-flat pull-right" id="summarizeberita" type="submit"><span class="btn-label"><i class="fa fa-plus-square"></i></span>&nbsp;Summarize</button>
                        <p class="help-block"></p>
